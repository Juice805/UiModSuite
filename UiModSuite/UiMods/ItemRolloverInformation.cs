...
namespace UiModSuite.UiMods {
	class ItemRolloverInformation {
		...
		List<string> bundleData = ModEntry.Helper.Content.Load<Dictionary<string, string>>(Path.Combine("Data", "Bundles.xnb"), StardewModdingAPI.ContentSource.GameContent).Values.ToList();
		...
		public void toggleOption(string identifier, bool IsOn) {
			...
			if (IsOn) {
				...
				bundleData = ModEntry.Helper.Content.Load<Dictionary<string, string>>(Path.Combine("Data", "Bundles.xnb"), StardewModdingAPI.ContentSource.GameContent).Values.ToList();
